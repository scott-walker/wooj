...
Персональная система управления заметками с возможностями организации и редактирования контента.
...
**WOOJ** - это веб-приложение для создания, организации и управления личными заметками ("вуджами"). Система позволяет структурировать информацию через систему топиков, поддерживает rich-text редактирование и предоставляет интуитивный интерфейс для работы с контентом.

### ✨ Основные возможности

- 📝 **Создание и редактирование заметок** с rich-text редактором (TipTap)
- 🏷️ **Топики** для организации контента
...
(блин, надо же было что-то написать... 🙃😇)

<img src="./etc/mobile.png" alt="WOOJ" width="100%" style="margin-bottom: 20px">

## 🏗️ Архитектура

Проект построен архитектуре с разделением на frontend и backend:
...
- **UI**: Кастомные компоненты и стили
...
- GitHub: [@scottwalker](https://github.com/scottwalker87)
- Project Link: [wooj.ru](https://github.com/scottwalker87/wooj)
